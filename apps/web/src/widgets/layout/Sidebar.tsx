          ...
          {!collapsed && (
            <div className="flex items-center gap-2">
              <NavLink
                ...
                title="立即新增"
                aria-label="立即新增"
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-sky-50 text-sky-600 transition-colors hover:bg-sky-100 hover:text-sky-700"
              >
                <Plus size={18} />
              </NavLink>
              <button
